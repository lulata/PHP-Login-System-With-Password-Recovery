...
if (isset($_POST["reset-request-submit"])) {
  ...
  $url="http://localhost/lulata/createnewpassword.php?selector=".$selector."&validator=". bin2hex($token);
  ...
  $subject = "Reset you password for lulata.com";
  ...
  $headers = "From: Lulata <davidatanasoski@hotmail.com>\r\n";
